...
export async function handleApiUpdateCommand(message: Message) {
  ...
  if (!params) {
    await message.reply('Please provide data to update. Usage: /api-update <ID> | <phrase> | <number> | <date>\nExample: /api-update 2 | Hello Updated | 99 | 2024-01-15 10:30:00');
    return;
  }
  ...
  if (parts.length !== 4) {
    await message.reply('Invalid format. Usage: /api-update <ID> | <phrase> | <number> | <date>\nExample: /api-update 2 | Hello Updated | 99 | 2024-01-15 10:30:00');
    return;
  }
